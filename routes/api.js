...
var kuhong = db.get('ojan'); 
	...
	console.log('GAUSAH DI JUAL AJG') // boleh diubah
}

var gausahganti = ['Wanz Botz']; // Nama Lu Ngab
var creator = gausahganti[Math.floor(Math.random() * gausahganti.length)]; // Ini jan diubah
var key = 'Wanz' 
